...
import { Spin, Card, Typography, Button, Avatar, Input, Form, Modal, Col, Row } from 'antd'
...
export default function UserAccountForm(props) {
	...
	const validationSchema = Yup.object({
		...
		last_name: Yup.string().min(2, 'Too Short').max(12, 'Too Long').matches(regexNoSpecial, 'No Special Character'),
		password: Yup.string()
			.min(6, 'Too Short')
			.max(12, 'Too Long')

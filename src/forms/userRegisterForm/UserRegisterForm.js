...
export default function UserRegisterForm() {
	...
	const validationSchema = Yup.object({
		...
		last_name: Yup.string()
			...
			.matches(regexNoSpecial, 'No Special Character')
			.required('Required'),
		email: Yup.string().min(6, 'Too Short').max(40, 'Too Long').email('Invalid Email').required('Required'),
		password: Yup.string()
			.min(6, 'Too Short')
			.max(12, 'Too Long')
		...
		<>
			<Row className='container-form'>
				...
				<Form onSubmit={handleSubmit} layout='vertical'>
					...
					<Row>
						<Col className='col-register-input'>
							<Form.Item label='Confirm Password' className='form-item-register'>
								<Input
									id='confirm_password'
									name='confirm_password'
									type='password'
									placeholder='Confirm Password'
									className={errors.confirm_password && touched.confirm_password && 'error_field'}
									onBlur={handleBlur}
						...
						<Col className='col-register-input'>
							<Form.Item label='First Name' className='form-item-register'>
								<Input
									...
									className={errors.first_name && touched.first_name && 'error_field'}
									onBlur={handleBlur}
						...
						<Col className='col-register-input'>
							<Form.Item label='Last Name' className='form-item-register'>
								<Input
									...
									className={errors.last_name && touched.last_name && 'error_field'}
									onBlur={handleBlur}
				...
				<Row>
					<Col className='col-register-button'>
						<Button id='btn-register' onClick={() => handleSubmit()} type='primary' disabled={isDisabled}>
							Register {isDisabled && <Spin size='small' indicator={antIcon} />}
						</Button>
					</Col>
				</Row>
				<Row>
					<Col className='col-register-button'>
						...
						<Button type='link' disabled={isDisabled} onClick={() => history.push('/login')}>
							Login
						</Button>
					</Col>
				</Row>
